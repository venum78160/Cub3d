...
/*   Updated: 2022/11/18 17:27:43 by mgoudin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int handle_path(char *line, int type, t_info *info)
{
	...
	if (type == 0)
	{
		...
		info->text.text_N->img = mlx_xpm_file_to_image(info->st_img.mlx , path, &x, &y);
	...
	if (type == 1)
	{
		...
		info->text.text_S->img = mlx_xpm_file_to_image(info->st_img.mlx , path, &x, &y);
	...
	if (type == 2)
	{
		...
		info->text.text_W->img = mlx_xpm_file_to_image(info->st_img.mlx , path, &x, &y);
	...
	if (type == 3)
	{
		...
		info->text.text_E->img = mlx_xpm_file_to_image(info->st_img.mlx , path, &x, &y);
